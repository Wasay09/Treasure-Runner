...
lib.game_engine_create.restype = GameEngineStatus
...
lib.game_engine_move_player.restype = GameEngineStatus

lib.game_engine_get_room_count.argtypes = [GameEngine, ctypes.POINTER(ctypes.c_int)]
lib.game_engine_get_room_count.restype = GameEngineStatus

lib.game_engine_get_room_dimensions.argtypes = [GameEngine, ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int)]
lib.game_engine_get_room_dimensions.restype = GameEngineStatus

lib.game_engine_reset.argtypes = [GameEngine]
lib.game_engine_reset.restype = GameEngineStatus

lib.game_engine_render_current_room.argtypes = [GameEngine, ctypes.POINTER(ctypes.c_char_p)]
lib.game_engine_render_current_room.restype = GameEngineStatus

lib.game_engine_get_room_ids.argtypes = [GameEngine, ctypes.POINTER(ctypes.POINTER(ctypes.c_int)), ctypes.POINTER(ctypes.c_int)]
lib.game_engine_get_room_ids.restype = GameEngineStatus

lib.game_engine_get_total_treasures.argtypes = [GameEngine, ctypes.POINTER(ctypes.c_int)]
lib.game_engine_get_total_treasures.restype = GameEngineStatus

lib.game_engine_use_portal.argtypes = [GameEngine]
lib.game_engine_use_portal.restype = GameEngineStatus

lib.game_engine_player_move_on_portal.argtypes = [GameEngine, ctypes.c_int]
lib.game_engine_player_move_on_portal.restype = GameEngineStatus

lib.game_engine_undo_move.argtypes = [GameEngine]
lib.game_engine_undo_move.restype = GameEngineStatus

lib.game_engine_reset_current_room.argtypes = [GameEngine]
lib.game_engine_reset_current_room.restype = GameEngineStatus

lib.game_engine_player_move_with_undo.argtypes = [GameEngine, ctypes.c_int]
lib.game_engine_player_move_with_undo.restype = GameEngineStatus
...
lib.player_get_position.restype = GameEngineStatus
...
lib.player_reset_to_start.restype = GameEngineStatus
